                ...
                <div className="bg-slate-950 text-white min-h-screen flex flex-col items-center justify-center">
                    <div className="max-w-4xl w-full px-4 relative">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
                            ...
                            >
                                <div
                                    className="absolute top-1/2 transform -translate-y-1/2 flex items-center justify-center w-full h-full">
                                    <Calculator
                                        className="h-16 w-16 text-white transition-transform transform group-hover:scale-125"/>
                                </div>
                                <div
                                    className="absolute inset-0 bg-black bg-opacity-60 flex flex-col items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 p-4 text-center">
                                ...
                                <div
                                    className="absolute inset-0 bg-gradient-to-t from-black via-transparent to-black opacity-0 group-hover:opacity-30 transition-opacity duration-300"></div>
                            </Link>
                            <Link
                                href="/modules/prog"
